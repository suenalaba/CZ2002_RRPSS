...
public class StaffManager {
	...
	public static void setListOfStaffMembers(ArrayList<Staff> wholeListOfStaffMembers) {
		listOfStaffMembers = wholeListOfStaffMembers;
	}
...
//	}
	...
	public static void createStaffMember(int staffId, String staffName, String staffTitle, Gender staffGender) {
		listOfStaffMembers.add(new Staff(staffId,staffName, staffTitle,staffGender));
		
		
	}
	
	public static void removeStaffMember(int removalStaffId) {
	...
	public static void updateStaffMember(String updatedStaffName, String updatedStaffTitle, int staffIdUpdate) {
