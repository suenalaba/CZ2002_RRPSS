...
public class ReservationManager {
	...
	public static void completeReservation(int reservationID) {
		...
		if (!toComplete.getReservationStartTime().toString().substring(11,13).contains("09")) {
			TableLayoutManager.updateTable(toComplete.getTableID(), Integer.parseInt(toComplete.getReservationStartTime().toString().substring(11,13))-1, status.OCCUPIED);
		}
